...
public class AristaTest 
{
	...
	{
		Vertice vertice1= new Vertice(1,0);
		Vertice vertice2= new Vertice(2,1);
		Vertice vertice3= new Vertice(3,2);
		Vertice vertice4= new Vertice(4,1); 
		arista1= new Arista(vertice1,vertice2);
		arista2= new Arista(vertice1,vertice2);
		arista3= new Arista(vertice3,vertice4);	
	}
